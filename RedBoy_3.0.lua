...
local allowedSteamNames = {
    'hjdnjhkfjnlkdf',
} 
if has_value(allowedSteamNames, SteamName) then
    
else
    print("Du har ikke købt den! kontakt KØDKONGEN#0001 for at købe.")
    print("Du har ikke købt den! kontakt KØDKONGEN#0001 for at købe.")
    print("Du har ikke købt den! kontakt KØDKONGEN#0001 for at købe.")
    print("Du har ikke købt den! kontakt KØDKONGEN#0001 for at købe.")
    print("Du har ikke købt den! kontakt KØDKONGEN#0001 for at købe.")
    print("Du har ikke købt den! kontakt KØDKONGEN#0001 for at købe.")
    print("Du har ikke købt den! kontakt KØDKONGEN#0001 for at købe.")
    print("Du har ikke købt mod menuen!!!!")
    print("Du har ikke købt mod menuen!!!!")
    print("Du har ikke købt mod menuen!!!!")
    print("Du har ikke købt mod menuen!!!!")
    print("Du har ikke købt den! kontakt KØDKONGEN#0001 for at købe.")
