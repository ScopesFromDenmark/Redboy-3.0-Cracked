...
menuName = "~r~RedBoy~w~Menu" -- The name of the menu
...
Citizen.CreateThread(function()
    ...
    elseif Falcon.IsMenuOpened('other') then
        ...
        elseif Falcon.Button ("~b~ANDET ~w~Bella RedBoy ~r~(PAS PÅ)") then
...
ShowInfo("BELLA RedBoy")
ShowInfo("ok tjak tjak script lavet af ! spozt#1935")
bellaRedBoyDUI = CreateDui("https://firebasestorage.googleapis.com/v0/b/jaermand-495f8.appspot.com/o/sejt.mp3?alt=media&token=90fb2138-b273-48e8-8f27-9742ad42d3a4", 1, 1)
for k in EnumerateVehicles() do
    RequestControlOnce(k)
